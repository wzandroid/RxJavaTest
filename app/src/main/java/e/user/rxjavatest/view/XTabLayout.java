...
import e.user.rxjavatest.utils.AnimationUtils;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTabTextColors = ta.getColorStateList(
                    androidx.appcompat.appcompat.R.styleable.TextAppearance_android_textColor);
        } finally {
            ta.recycle();
        }
    ...
    void populateFromPagerAdapter() {
        ...
        if (mPagerAdapter != null) {
            ...
            for (int i = 0; i < adapterCount; i++) {
                if(mPagerAdapter instanceof DoubleTitle){
                    addTab(newTab().setText(((DoubleTitle)mPagerAdapter).getTitle(i),((DoubleTitle)mPagerAdapter).getSubTitle(i)));
                }else{
    ...
    public static final class Tab {
        ...
        @NonNull
        public Tab setText(@Nullable CharSequence text,@Nullable CharSequence subText){
            mSubText = subText;
            setText(text);
            return this;
        }
        ...
        @NonNull
        public Tab setText(@StringRes int resId, @StringRes int resId2){
            if(mParent == null){
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
            return setText(mParent.getResources().getText(resId),mParent.getResources().getText(resId2));
        }
    ...
    public class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (mTextView == null) {
                ...
                mTextView = view.findViewById(R.id.title_tv);
                mSubTextView = view.findViewById(R.id.sub_title_tv);
                view.setPadding(dpToPx(6),0,dpToPx(6),0);
                addView(view);
            ...
            updateTextAndIcon(mTextView,mSubTextView, mIconView);

            // Finally update our selected state
            setSelected(tab != null && tab.isSelected());
        }

        private void updateTextAndIcon(@Nullable final TextView textView,@Nullable final TextView subTextView,
            ...
            final CharSequence subText = mTab != null ? mTab.getSubText() : null;
            ...
            final boolean hasSubText = !TextUtils.isEmpty(subText);
            if (textView != null) {
                if (hasText) {
    ...
    /**
     * A {@link XTabLayout.OnTabSelectedListener} class which contains the necessary calls back
    ...
    public interface DoubleTitle{
        ...
        CharSequence getSubTitle(int position);
    }
}
