...
import static e.user.snackbarutils.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBar<B extends BaseTransientBar<B>> {
     ...
     * @see BaseTransientBar#addCallback(BaseTransientBar.BaseCallback)
     */
    public abstract static class BaseCallback<B> {
         ...
         */
        public void onDismissed(B transientBottomBar, @BaseTransientBar.BaseCallback.DismissEvent int event) {
            // empty
        }
    ...
    final BaseTransientBar.SnackbarBaseLayout mView;
    private final BaseTransientBar.ContentViewCallback mContentViewCallback;
    ...
    protected BaseTransientBar(@NonNull ViewGroup parent, @NonNull View content,
                               @NonNull ContentViewCallback contentViewCallback, boolean top) {
        if (parent == null) {
     ...
     */
    @NonNull
    public B addCallback(@NonNull BaseTransientBar.BaseCallback<B> callback) {
        if (callback == null) {
            return (B) this;
        }
        if (mCallbacks == null) {
