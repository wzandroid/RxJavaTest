...
public class ImageWatcherHelper {
    ...
    public static ImageWatcherHelper with(Activity activity, ImageWatcher.Loader l) { // attach
        ...
        if (l == null) {
            iwh.loader = new GlideSimpleLoader();
        }else{
            iwh.loader = l;
        }
        return iwh;
    ...
    public void show(ImageView i, SparseArray<ImageView> imageGroupList, List<String> urlList) {
        init();
    ...
    private static class GlideSimpleLoader implements ImageWatcher.Loader{
